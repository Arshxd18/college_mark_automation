...
const FuseButton: React.FC<FuseButtonProps> = ({
  ...
  const actionIcon = icon ?? <ArrowRight size={preset.icon} strokeWidth={1.8} />;
  const line = (
    <i
      ref={lineRef}
    ...
    >
      ...
      >
        <span
          ...
          aria-hidden="true"
        >
          <RotateCcw size={preset.icon} strokeWidth={2} />
        </span>
        {undoLabel}
...
// npx shadcn@latest add @react-bits/FuseButton-TS-TW